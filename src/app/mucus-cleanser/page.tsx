...
export default function MucusCleanserPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && window.gtag) {
      window.gtag('event', 'view_item', {
        ...
        value: price,
        items: [{
          item_id: 'mucus-cleanser',
          item_name: 'Mucus Cleanser',
    ...
    fpixel.event('ViewContent', {
      content_ids: ['mucus-cleanser'],
      content_type: 'product',
      content_name: 'Mucus Cleanser',
  ...
  const handleAddToCart = () => {
    ...
    window.location.href = `/checkout?product=mucus-cleanser&quantity=${quantity}`;
  };
              ...
              <div className="flex flex-col">
                ...
                <div className="mb-6 p-6 bg-gradient-to-br from-yellow-50 to-yellow-100/50 rounded-2xl border-2 border-yellow-350/30">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Respiratory and cellular support formula designed to help your body maintain healthy mucus balance.
                  </p>
                </div>
        ...
        <section className="w-full py-12 bg-gradient-to-br from-black via-gray-900 to-black">
          <div className="container px-4 md:px-6 max-w-[800px] mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Support Clear Breathing Naturally
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Help your body maintain healthy mucus balance with Dr. Sebi&apos;s respiratory support formula.
            </p>
            <Button
              onClick={handleAddToCart}
              size="lg"
