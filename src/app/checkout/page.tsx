              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-900 text-sm">30-Day Money Back Guarantee</h4>
                      <p className="text-xs text-gray-600 mt-1">Not satisfied? Get a full refund, no questions asked.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-900 text-sm">100% Authentic</h4>
                      <p className="text-xs text-gray-600 mt-1">Original Dr. Sebi formulas, made in Honduras.</p>
                    </div>
                  </div>
                </div>
              </div>
