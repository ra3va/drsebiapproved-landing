        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-white to-cyan-500/10 pt-12 pb-16">
          ...
          <div className="container relative mx-auto px-4 max-w-[1200px]">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-gray-700 max-w-[700px] mx-auto mb-6">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start max-w-5xl mx-auto mb-12">
              {/* Left: Product Image */}
              <div className="flex flex-col items-center">
                <div className="relative w-full max-w-md bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-3xl p-8 mb-6 border-2 border-cyan-500/20">
                  <Image
                    src="/mucus.png"
                ...
                <div className="space-y-3 w-full max-w-md">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 bg-white/80 backdrop-blur-sm rounded-lg p-3 border border-cyan-500/20">
              ...
              <div className="flex flex-col justify-center">
                {!hasOptedIn ? (
                  <div className="space-y-6">
                    {/* Countdown Timer */}
                    <div className="bg-white rounded-2xl p-6 shadow-xl border-2 border-red-500/20">
                    ...
                    {/* Pricing Display */}
                    <div className="bg-gradient-to-r from-green-50 to-cyan-50 rounded-2xl p-8 border-2 border-green-500/30">
                      <p className="text-center text-sm text-gray-600 mb-2">Regular Price</p>
                      <p className="text-center text-3xl font-bold text-gray-400 line-through mb-4">$39.99</p>

                      <div className="flex items-center justify-center gap-3 mb-4">
                        <ArrowRight className="w-6 h-6 text-green-600" />
                        <div className="text-center">
                          <p className="text-sm text-green-600 font-semibold mb-1">Your Return Customer Price</p>
                          <p className="text-5xl font-bold text-green-600">$24.99</p>
                        </div>
                        <ArrowRight className="w-6 h-6 text-green-600" />
                      </div>

                      <div className="bg-white rounded-lg p-4 text-center border border-green-500/30">
                        <p className="text-2xl font-bold text-green-600 mb-1">Save $15</p>
                        <p className="text-sm text-gray-600">That's 37% OFF just for returning!</p>
                      </div>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-green-500/10 to-cyan-500/10 rounded-3xl p-8 border-2 border-green-500/30 shadow-xl">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-600">Code: <strong className="text-green-600 text-xl">{discountCode}</strong></p>
                    </div>
          ...
          <div className="container mx-auto px-4 max-w-[1200px]">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-red-50 px-4 py-2 rounded-lg mb-4">
                ...
                <span className="text-red-600 font-semibold">Flu Season Alert</span>
              </div>
