...
export default function ParaCleansePage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && window.gtag) {
      window.gtag('event', 'view_item', {
        ...
        value: price,
        items: [{
          item_id: 'paracleanse-elite',
          item_name: 'ParaCleanse Elite',
    ...
    fpixel.event('ViewContent', {
      content_ids: ['paracleanse-elite'],
      content_type: 'product',
      content_name: 'ParaCleanse Elite',
  ...
  const handleAddToCart = () => {
    ...
    window.location.href = `/checkout?product=paracleanse&quantity=${quantity}`;
  };
              ...
              <div className="flex flex-col">
                ...
                <div className="mb-6 p-6 bg-gradient-to-br from-yellow-50 to-yellow-100/50 rounded-2xl border-2 border-yellow-500/30">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Complete 14-day protocol for internal cleansing and digestive wellness.
                  </p>
                </div>
        ...
        <section className="w-full py-12 bg-gradient-to-br from-black via-gray-900 to-black">
          <div className="container px-4 md:px-6 max-w-[800px] mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Take the next step in your wellness journey with Dr. Sebi&apos;s complete two-phase internal cleansing system.
            </p>
            <Button
              onClick={handleAddToCart}
              size="lg"
