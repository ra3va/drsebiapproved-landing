...
import { CheckCircle, Star, ShoppingCart, Gift, Users, TrendingUp, Award, ShieldCheck, Download, Zap, Heart } from 'lucide-react'
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && window.gtag) {
      window.gtag('event', 'view_item', {
        ...
        value: salePrice,
        items: [{
          item_id: 'maya-formula-bf',
          item_name: 'Maya Formula - Black Friday',
